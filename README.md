...
4. Які товари продаються найкраще? - ✅
   ...
   | Product Name                             | Sum of Qty |
   | ---------------------------------------- | ---------- |
   | Нові Темні Віки. Книга 1. Колонія        | 161        |
   | Кров і попіл. Книга 1. Із крові й попелу | 154        |
   | Тисяча пам'ятних поцілунків              | 149        |
...
В реальних умовах спочатку перевірила б дані з першоджерелом, можливо дані зїхали при експорті чи розрахунках. Потім обговорила б з колегами логіку розрахунку знижок.
...
1. скільки замовлень виконано
2. скільки не виконано
3. скільки часу займає fulfillment
4. скільки замовлень мають проблеми
...
1. кількість відправлень
2. середній час доставки
3. затримки
4. перевізників
5. вартість доставки
6. успішність доставки

- **Етап 7. Delivery Performance**
...
1. Чи є Invoice ID?
2. Чи є дата?
3. Чи правильно розрахована сума?
4. Чи відповідає invoice тому, що було замовлено?
...
- **Етап 10. Reconciliation**

1. чи всі SKU існують у reference table
2. чи всі promo codes існують
3. чи всі shipping records можна прив'язати до orders

- **Етап 11. Returns / Refunds**

## Publisher Analysis Tab

**Який % видавництв приносить 80% виручки?**

12% видавництв формують 80% Net Revenue.
